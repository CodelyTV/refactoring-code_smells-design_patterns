...
import com.codely.payment.stripe.PaymentGatewayStripe
import com.codely.payment.stripe.StripeClient
...
class MakePaymentTest {
    ...
    @Test
    fun `it should create a payment with Stripe`() {
        val gateway = PaymentGatewayStripe(StripeClient())
        val makePayment = MakePayment(gateway)
        val customer = CustomerData("customerId", "customerName")
        val card = CardData("cardName", "4242424242424242")
        val amount = 5
